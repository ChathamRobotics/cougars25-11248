...
public final class TuningOpModes {
    ...
    public static final Class<?> DRIVE_CLASS = BaseMecanumDrive.class;
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(BaseMecanumDrive.class)) {
            dvf = hardwareMap -> {
                BaseMecanumDrive md = new BaseMecanumDrive(hardwareMap, new Pose2d(0, 0, 0));

                List<Encoder> leftEncs = new ArrayList<>(), rightEncs = new ArrayList<>();
                List<Encoder> parEncs = new ArrayList<>(), perpEncs = new ArrayList<>();
                if (md.localizer instanceof BaseMecanumDrive.DriveLocalizer) {
                    BaseMecanumDrive.DriveLocalizer dl = (BaseMecanumDrive.DriveLocalizer) md.localizer;
                ...
                return new DriveView(
                    DriveType.MECANUM,
                        BaseMecanumDrive.PARAMS.inPerTick,
                        BaseMecanumDrive.PARAMS.maxWheelVel,
                        BaseMecanumDrive.PARAMS.minProfileAccel,
                        BaseMecanumDrive.PARAMS.maxProfileAccel,
                        ...
                        md.lazyImu,
                        md.voltageSensor,
                        () -> new MotorFeedforward(BaseMecanumDrive.PARAMS.kS,
                                BaseMecanumDrive.PARAMS.kV / BaseMecanumDrive.PARAMS.inPerTick,
                                BaseMecanumDrive.PARAMS.kA / BaseMecanumDrive.PARAMS.inPerTick)
                );
            };
